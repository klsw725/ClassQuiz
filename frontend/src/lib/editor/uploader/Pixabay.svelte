...
{:then data}
	...
	{:else}
		<div class="flex w-screen p-8 h-full mt-8 mb-1">
			<div
				class="cq-card flex flex-col w-1/3 m-auto overflow-scroll h-full p-4 gap-2"
			>
				...
				>
					<input
						class="cq-surface w-full outline-hidden p-1 rounded-lg"
					...
					<div class="cq-card p-2 flex-col flex gap-2">
						<div>
							<img
								...
								loading="lazy"
								alt="unavailable"
								class="object-contain w-full h-full rounded-lg max-h-[80vh]"
							/>
						</div>
						<BrownButton
							onclick={() => {
